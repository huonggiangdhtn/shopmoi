...
class CategoryController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Shopping::categories.index', compact('categories', 'breadcrumb', 'active_menu'));
    }
    public function categorySearch(Request $request)
    {
        ...
        if ($request->datasearch) {
            ...
            return view('Shopping::categories.search', compact('categories', 'breadcrumb', 'searchdata', 'active_menu'));
        } else {
            return redirect()->route('admin.category.index')->with('success', 'Không có thông tin tìm kiếm!');
        }
    }
    ...
    public function create()
    {
        ...
        return view('Shopping::categories.create', compact('breadcrumb', 'active_menu', 'parent_cats'));
    }
    ...
    public function edit(string $id)
    {
        ...
        if ($category) {
            ...
            $parent_cats = Category::where('is_parent', 1)->orderBy('title', 'ASC')->get();
            return view('Shopping::categories.edit', compact('breadcrumb', 'category', 'active_menu', 'parent_cats'));
        } else {
