...
class BrandController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Shopping::brands.index', compact('brands', 'breadcrumb', 'active_menu'));
    }
    ...
    public function brandSearch(Request $request)
    {
        ...
        if ($request->datasearch) {
            ...
            $breadcrumb = '
            <li class="breadcrumb-item"><a href="#">/</a></li>
            <li class="breadcrumb-item  " aria-current="page"><a href="' . route('admin.brand.index') . '">Nhà sản xuất</a></li>
            <li class="breadcrumb-item active" aria-current="page"> tìm kiếm </li>';
            return view('Shopping::brands.search', compact('brands', 'breadcrumb', 'searchdata', 'active_menu'));
        } else {
            return redirect()->route('admin.brand.index')->with('success', 'Không có thông tin tìm kiếm!');
        }
    }
    ...
    public function create()
    {
        ...
        return view('Shopping::brands.create', compact('breadcrumb', 'active_menu'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($status) {
            return redirect()->route('admin.brand.index')->with('success', 'Tạo brand thành công!');
        } else {
    ...
    public function edit(string $id)
    {
        ...
        if ($brand) {
            ...
            return view('Shopping::brands.edit', compact('breadcrumb', 'brand', 'active_menu'));
        } else {
    ...
    public function destroy(string $id)
    {
        ...
        if ($brand) {
            $status = $brand->delete();
            if ($status) {
                return redirect()->route('admin.brand.index')->with('success', 'Xóa brand thành công!');
            } else {
