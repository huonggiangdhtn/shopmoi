...
use App\Modules\Shopping\Models\Order;
use App\Modules\Shopping\Models\OrderDetail;
...
class OrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Shopping::orders.index', compact('orders', 'breadcrumb', 'active_menu'));
    }
    ...
    public function show(string $id)
    {
        ...
        if ($order) {
            ...
            $breadcrumb = '
            <li class="breadcrumb-item"><a href="#">/</a></li>
            <li class="breadcrumb-item  " aria-current="page"><a href="' . route('admin.order.index') . '">DS đặt hàng</a></li>
            <li class="breadcrumb-item active" aria-current="page"> Xem chi tiết</li>';
            $wo_details = OrderDetail::where('wo_id', $id)->get();
            return view('Shopping::orders.show', compact('breadcrumb', 'order', 'active_menu', 'wo_details'));
        } else {
