...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
        <a href="{{route('admin.product.create')}}" class="btn btn-primary shadow-md mr-2">Thêm hàng hóa</a>
    ...
    <div class=" intro-y col-span-12 flex flex-col sm:flex-row sm:items-end xl:items-start">
        <form action="{{route('admin.product.sort')}}" method="get" class="xl:flex sm:mr-auto">
            <!-- @csrf -->
        ...
        <div class="flex mt-5 sm:mt-0">
            <a href="{{route('admin.product.print')}}" id="tabulator-print" class="btn btn-outline-secondary w-1/2 sm:w-auto mr-2"> <i data-lucide="printer" class="w-4 h-4 mr-2"></i> Print </a>
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
        <table class="table table-report -mt-2">
            ...
            <tbody>
                ...
                <tr class="intro-x">
                    <td>
                        <a href="{{route('admin.product.show',$item->id)}}" class="font-medium  ">{{$item->title}}</a>
                    ...
                    <td>
                        {{$item->cat_id!=null ? \App\Modules\Shopping\Models\Category::where('id',$item->cat_id)->value('title'):''}}
                            ...
                            <div class="dropdown py-3 px-1 ">
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        <li><a class="dropdown-item" href="{{route('admin.product.priceview',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="credit-card" class="w-4 h-4 mr-1"></i> Thiết lập giá</a></li>
                                        <li><a class="dropdown-item" href="{{route('admin.product.edit',$item->id)}}" class="flex items-center mr-3" href="javascript:;"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a></li>
