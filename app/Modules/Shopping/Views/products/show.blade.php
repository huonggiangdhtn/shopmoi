                        ...
                        <div class="grid grid-cols-12 gap-x-5">
                            ...
                            <div class="col-span-12 2xl:col-span-6">
                                <div>
                                    ...
                                    {{$product->cat_id!=null ? \App\Modules\Shopping\Models\Category::where('id',$product->cat_id)->value('title'):''}}
                            ...
                            <div class="col-span-12 2xl:col-span-6">
                                <div>
                                    ...
                                    {{$product->brand_id!=null ? \App\Modules\Shopping\Models\Brand::where('id',$product->brand)->value('title'):''}}
