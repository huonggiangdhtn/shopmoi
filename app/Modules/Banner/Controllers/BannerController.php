...
class BannerController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Banner::index', compact('banners', 'breadcrumb', 'active_menu'));
    }
    public function bannerSearch(Request $request)
    {
        ...
        if($request->datasearch)
        {
            ...
            $breadcrumb = '
            <li class="breadcrumb-item"><a href="#">/</a></li>
            <li class="breadcrumb-item  " aria-current="page"><a href="'.route('admin.banner.index').'">Banners</a></li>
            <li class="breadcrumb-item active" aria-current="page"> tìm kiếm </li>';
        
            return view('Banner::search', compact('banners','breadcrumb','searchdata','active_menu'));
        }
        else
        {
            return redirect()->route('admin.banner.index')->with('success','Không có thông tin tìm kiếm!');
        }
    ...
    public function create()
    {
        ...
        return view('Banner::create', compact('breadcrumb', 'active_menu'));
    }
    ...
    public function edit(string $id)
    {
        ...
        if($banner)
        {
            ...
            return view('Banner::edit', compact('banner', 'breadcrumb', 'active_menu'));
        }
        else
        {
