...
class WarehouseController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('Warehouse::warehouses.index', compact('warehouses','breadcrumb','active_menu'));
    }
    public function warehouseSearch(Request $request)
    {
        ...
        if($request->datasearch)
        {
            ...
            $breadcrumb = '
            <li class="breadcrumb-item"><a href="#">/</a></li>
            <li class="breadcrumb-item  " aria-current="page"><a href="'.route('admin.warehouse.index').'">Kho</a></li>
            <li class="breadcrumb-item active" aria-current="page"> tìm kiếm </li>';
        
            return view('Warehouse::warehouses.search', compact('warehouses','breadcrumb','searchdata','active_menu'));
        }
        else
        {
            return redirect()->route('admin.warehouse.index')->with('success','Không có thông tin tìm kiếm!');
        }
    ...
    public function create()
    {
        ...
        return view('Warehouse::warehouses.create', compact('breadcrumb','active_menu'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if($status){
            return redirect()->route('admin.warehouse.index')->with('success','Tạo warehouse thành công!');
        }
        else
        {
    ...
    public function edit(string $id)
    {
        ...
        if($warehouse)
        {
            ...
            $breadcrumb = '
            <li class="breadcrumb-item"><a href="#">/</a></li>
            <li class="breadcrumb-item  " aria-current="page"><a href="'.route('admin.warehouse.index').'">Danh sách kho</a></li>
            <li class="breadcrumb-item active" aria-current="page"> điều chỉnh nhóm người dùng </li>';

            return view('Warehouse::warehouses.edit', compact('breadcrumb','warehouse','active_menu'));
        }
        else
        {
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($warehouse)
        {
            ...
            if($status){
                return redirect()->route('admin.warehouse.index')->with('success','Cập nhật thành công');
            }
            else
            {
