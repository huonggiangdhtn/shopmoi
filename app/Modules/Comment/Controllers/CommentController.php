...
class CommentController extends Controller
{
    ...
    public function index()
    {
        ...
        // categories
        return view('Comment::index', compact('comments', 'breadcrumb', 'active_menu'));
    ...
    public function create()
    {
        ...
        //
        $data['categories'] = Comment::where('status','active')->orderBy('id','DESC')->get();
         $data['active_menu']="comment_add";
        $data['breadcrumb'] = '
        <li class="breadcrumb-item"><a href="#">/</a></li>
        <li class="breadcrumb-item  " aria-current="page"><a href="'.route('admin.comment.index').'">bình luận</a></li>
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.comment.index')->with('success','Tạo comment thành công!');
    }
    public function edit(string $id)
    {
        ...
        if($comment)
        {
            $breadcrumb = '
            <li class="breadcrumb-item"><a href="#">/</a></li>
            <li class="breadcrumb-item  " aria-current="page"><a href="'.route('admin.comment.index').'">Danh mục</a></li>
            <li class="breadcrumb-item active" aria-current="page"> điều chỉnh danh mục </li>';
            return view('Comment::edit', compact('breadcrumb', 'comment', 'active_menu'));
        }
        else
        {
    ...
    public function update(Request $request, string $id)
    {
        ...
        if($comment)
        {
            ...
            if($status){
                return redirect()->route('admin.comment.index')->with('success','Cập nhật thành công');
            }
            else
            {
    ...
    public function destroy(string $id)
    {
        ...
        if($comment)
        {
            ...
            if($status){
                return redirect()->route('admin.comment.index')->with('success','Xóa comment thành công!');
            }
            else
            {
    ...
    public function commentSearch(Request $request)
    {
        ...
        if($request->datasearch)
        {
            ...
            return view('Comment::search', compact('comments', 'breadcrumb', 'searchdata', 'active_menu'));
            
        }
        else
        {
            return redirect()->route('admin.comment.index')->with('success','Không có thông tin tìm kiếm!');
        }
